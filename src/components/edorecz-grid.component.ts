        ...
        <div class="sub-panels">
          <div class="attachments-panel">
            <div class="panel-header">
              ...
              <button class="download-button" (click)="pobierzZalaczniki()">Pobierz</button>
            </div>
...
export class EDoreczGridComponent implements OnInit, OnChanges {
  ...
  loadData() {
    ...
    this.edoreczService.getEDoreczDokumenty().subscribe({
      ...
      error: (error) => {
        console.error('Error loading eDoreczenia:', error);
        this.loading = false;
      }
    });
  }
  ...
  pobierzZalaczniki() {
    console.log('Pobieranie załączników dla dokumentu:', this.selectedDokument?.numer);
  }
